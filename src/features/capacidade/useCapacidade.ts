...
export interface ClienteAlocado { nome: string; pacote: PacoteServico; pct: number; horas: number; }
...
export function useCapacidade() {
  ...
  return { porColaborador, absorcaoPorPacote, horasLivresPorFuncao, custoMedioPorFuncao, simular, loading };
}
